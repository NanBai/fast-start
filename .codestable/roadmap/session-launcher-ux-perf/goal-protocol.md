...
本文件复制到 `.codestable/roadmap/session-launcher-ux-perf/goal-protocol.md` 后，由 `/goal` 会话读取。详细执行规则拆到同目录子文档，避免单个 md 超过 300 行。

## 1. 先读文件

- `.codestable/roadmap/session-launcher-ux-perf/goal-state.yaml`
- `.codestable/roadmap/session-launcher-ux-perf/goal-plan.md`
- `session-launcher-ux-perf-roadmap.md`
- `session-launcher-ux-perf-items.yaml`
- `.codestable/roadmap/session-launcher-ux-perf/goal-features/*.md`
- `.codestable/roadmap/session-launcher-ux-perf/goal-protocol-feature-loop.md`
- `.codestable/roadmap/session-launcher-ux-perf/goal-protocol-gates.md`
- `.codestable/roadmap/session-launcher-ux-perf/goal-protocol-audit.md`
...
Plan: .codestable/roadmap/session-launcher-ux-perf/goal-plan.md
Protocol: .codestable/roadmap/session-launcher-ux-perf/goal-protocol.md
```
